...
public abstract class MovableAreaEntity extends AreaEntity {
     ...
     * @param startingPositions (Coordinate): Initial position of the entity. Not null
     * @param orientation (Orientation): Initial orientation of the entity. Not null
     */
    public MovableAreaEntity(Area area, Orientation orientation, DiscreteCoordinates startingPositions) {
        super(area, orientation, startingPositions);
        resetMotion();
    }
