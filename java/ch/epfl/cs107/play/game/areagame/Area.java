...
public abstract class Area implements Playable {
	...
	public void getActors(){
		System.out.println(registeredActors);
	}
	/**
	...
	/*
	 * Method used to access the Graph in SuperPacmanBehavior and be accessible to Ghost class
	 * @return the Orientation to get to the SuperPacmanPlayer
	 */
	public Queue<Orientation> shortestPath(DiscreteCoordinates ghost, DiscreteCoordinates superPacman) {
		Queue<Orientation> path;
		return path = SuperPacmanBehavior.areaGraph.shortestPath(ghost, superPacman);
	}
